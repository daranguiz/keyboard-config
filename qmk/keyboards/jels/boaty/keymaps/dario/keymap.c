...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE_PRIMARY] = LAYOUT(
        ...
        KC_D                , KC_Z                , KC_QUOT             , KC_W                , KC_MINS             , KC_SCLN             , KC_COMM             , LT(NUM, KC_BSPC)    , LT(SYM, KC_R)       , LSFT_T(QK_AREP)     , LSFT_T(KC_TAB)      , LT(NAV, KC_SPC)     , LT(MEDIA, KC_ENT)   
    ),
    [BASE_ALT] = LAYOUT(
        KC_PMNS             , KC_PSLS             , KC_PAST             , KC_P7               , KC_P8               , KC_P9               , KC_P4               , KC_P5               , KC_P6               , KC_PPLS             , KC_P1               , KC_P2               ,
        KC_P3               , KC_PENT             , KC_NUM_LOCK         , KC_P0               , KC_P0               , KC_PDOT             , KC_PENT             , KC_PEQL             , KC_BSPC             , KC_ESC              , KC_TAB              , KC_B                ,
    ...
    [NUM] = LAYOUT(
        ...
        KC_TILD             , KC_PERC             , KC_NO               , KC_NO               , KC_CIRC             , KC_7                , KC_8                , KC_9                , KC_DOT              , KC_TRNS             , KC_TRNS             , KC_TRNS             ,
        KC_LGUI             , KC_LALT             , KC_LCTL             , KC_LSFT             , KC_PIPE             , KC_HASH             , KC_1                , KC_2                , KC_3                , KC_GRV              , KC_TRNS             , LGUI(KC_Z)          , LGUI(KC_X)          , LGUI(KC_C)          ,
        LGUI(KC_V)          , SGUI(KC_Z)          , KC_COLN             , KC_4                , KC_5                , KC_6                , KC_COMM             , KC_NO               , KC_NO               , KC_NO               , KC_SLSH             , KC_0                , KC_AT               
    ),
    [SYM] = LAYOUT(
        KC_TRNS             , KC_TRNS             , KC_TRNS             , KC_TRNS             , KC_TRNS             , KC_TRNS             , KC_TRNS             , KC_TRNS             , KC_TRNS             , KC_TRNS             , KC_TRNS             , KC_TRNS             ,
        KC_TRNS             , KC_TRNS             , KC_TRNS             , KC_TRNS             , KC_TRNS             , KC_TRNS             , KC_TRNS             , KC_TRNS             , KC_TRNS             , KC_TRNS             , KC_TRNS             , KC_DLR              ,
        KC_ASTR             , KC_PERC             , KC_BSLS             , KC_NO               , KC_PLUS             , KC_LT               , KC_LCBR             , KC_RCBR             , KC_GT               , KC_TRNS             , KC_TRNS             , KC_TRNS             ,
        KC_LGUI             , KC_LALT             , KC_LCTL             , KC_LSFT             , KC_EQL              , KC_EXLM             , KC_QUES             , KC_LPRN             , KC_RPRN             , KC_SCLN             , KC_TRNS             , KC_NO               , KC_NO               , KC_NO               ,
        KC_AMPR             , KC_NO               , KC_COLN             , KC_MINS             , KC_LBRC             , KC_RBRC             , KC_COMM             , KC_NO               , KC_NO               , KC_NO               , KC_SLSH             , KC_SPC              , KC_ENT              
    ),
    [NAV] = LAYOUT(
        KC_TRNS             , KC_TRNS             , KC_TRNS             , KC_TRNS             , KC_TRNS             , KC_TRNS             , KC_TRNS             , KC_TRNS             , KC_TRNS             , KC_TRNS             , KC_TRNS             , KC_TRNS             ,
