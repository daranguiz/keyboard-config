...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE_PRIMARY] = LAYOUT(
        ...
        KC_F                , KC_L                , KC_D                , KC_Q                , KC_J                , KC_G                , KC_O                , KC_U                , KC_DOT              , KC_BSPC             , KC_DEL              , KC_CAPS             ,
        LGUI_T(KC_N)        , LALT_T(KC_S)        , LCTL_T(KC_H)        , LSFT_T(KC_T)        , KC_K                , KC_Y                , LSFT_T(KC_C)        , LCTL_T(KC_A)        , LALT_T(KC_E)        , LGUI_T(KC_I)        , KC_ENT              , KC_X                , KC_V                , KC_M                ,
        KC_P                , KC_Z                , KC_QUOT             , KC_W                , KC_MINS             , KC_SLSH             , KC_COMM             , LT(NUM, QK_AREP)    , LT(SYM, KC_R)       , LSFT_T(KC_BSPC)     , LSFT_T(KC_TAB)      , LT(NAV, KC_SPC)     , LT(MEDIA, KC_ENT)   
    ),
    [BASE_ALT] = LAYOUT(
        KC_PMNS             , KC_PSLS             , KC_PAST             , KC_P7               , KC_P8               , KC_P9               , KC_P4               , KC_P5               , KC_P6               , KC_PPLS             , KC_P1               , KC_P2               ,
        KC_P3               , KC_PENT             , KC_NUM_LOCK         , KC_P0               , KC_P0               , KC_PDOT             , KC_PENT             , KC_PEQL             , KC_BSPC             , KC_ESC              , KC_TAB              , KC_B                ,
    ...
    [BASE_ALT2] = LAYOUT(
        KC_PMNS             , KC_PSLS             , KC_PAST             , KC_P7               , KC_P8               , KC_P9               , KC_P4               , KC_P5               , KC_P6               , KC_PPLS             , KC_P1               , KC_P2               ,
        KC_P3               , KC_PENT             , KC_NUM_LOCK         , KC_P0               , KC_P0               , KC_PDOT             , KC_PENT             , KC_PEQL             , KC_BSPC             , KC_ESC              , KC_TAB              , KC_B                ,
        KC_F                , KC_L                , KC_K                , KC_Q                , KC_J                , KC_G                , KC_O                , KC_U                , KC_DOT              , KC_BSPC             , KC_DEL              , KC_CAPS             ,
        LGUI_T(KC_N)        , LALT_T(KC_S)        , LCTL_T(KC_H)        , LSFT_T(KC_T)        , KC_M                , KC_Y                , LSFT_T(KC_C)        , LCTL_T(KC_A)        , LALT_T(KC_E)        , LGUI_T(KC_I)        , KC_ENT              , KC_X                , KC_V                , KC_P                ,
        KC_D                , KC_Z                , KC_QUOT             , KC_W                , KC_MINS             , KC_SLSH             , KC_COMM             , LT(NUM, QK_AREP)    , LT(SYM, KC_R)       , LSFT_T(KC_BSPC)     , LSFT_T(KC_TAB)      , LT(NAV, KC_SPC)     , LT(MEDIA, KC_ENT)   
    ),
    [SYM] = LAYOUT(
    ...
    [NUM] = LAYOUT(
        KC_TRNS             , KC_TRNS             , KC_TRNS             , KC_TRNS             , KC_TRNS             , KC_TRNS             , KC_TRNS             , KC_TRNS             , KC_TRNS             , KC_TRNS             , KC_TRNS             , KC_TRNS             ,
        KC_TRNS             , KC_TRNS             , KC_TRNS             , KC_TRNS             , KC_TRNS             , KC_TRNS             , KC_TRNS             , KC_TRNS             , KC_TRNS             , KC_TRNS             , KC_TRNS             , KC_AMPR             ,
        KC_PERC             , KC_DLR              , OSL(SYM_SHADOW)     , KC_NO               , KC_LBRC             , KC_7                , KC_8                , KC_9                , KC_DOT              , KC_TRNS             , KC_TRNS             , KC_TRNS             ,
        LGUI_T(KC_LABK)     , LALT_T(KC_RABK)     , LCTL_T(KC_LBRC)     , LSFT_T(KC_RBRC)     , KC_NO               , KC_RBRC             , KC_1                , KC_2                , KC_3                , KC_0                , KC_TRNS             , LGUI(KC_Z)          , LGUI(KC_X)          , LGUI(KC_C)          ,
        LGUI(KC_V)          , SGUI(KC_Z)          , KC_HASH             , KC_4                , KC_5                , KC_6                , KC_COMM             , KC_NO               , KC_NO               , KC_NO               , QK_AREP             , KC_SPC              , KC_ENT              
    ),
    [NAV] = LAYOUT(
        KC_TRNS             , KC_TRNS             , KC_TRNS             , KC_TRNS             , KC_TRNS             , KC_TRNS             , KC_TRNS             , KC_TRNS             , KC_TRNS             , KC_TRNS             , KC_TRNS             , KC_TRNS             ,
...
uint16_t get_alt_repeat_key_keycode_user(uint16_t keycode, uint8_t mods) {
    ...
    if (base_layer == BASE_ALT2) {
        switch (keycode) {
            ...
            case KC_C: return KC_Y;
            case KC_G: return KC_Y;
            case KC_B: return MAGIC_ALT2_B;
            case KC_I: return MAGIC_ALT2_I;
            case KC_J: return MAGIC_ALT2_J;
            case KC_M: return MAGIC_ALT2_M;
            case KC_N: return MAGIC_ALT2_N;
            case KC_Q: return MAGIC_ALT2_Q;
            case KC_T: return MAGIC_ALT2_T;
            case KC_W: return MAGIC_ALT2_W;
...
uint16_t magic_training_first_keycode(uint16_t keycode) {
    switch (keycode) {
        case MAGIC_ALT2_B: return KC_NO;
        case MAGIC_ALT2_CHR_32: return KC_NO;
        case MAGIC_ALT2_CHR_44: return KC_NO;
        case MAGIC_ALT2_I: return KC_NO;
        case MAGIC_ALT2_J: return KC_NO;
        case MAGIC_ALT2_M: return KC_NO;
        case MAGIC_ALT2_N: return KC_NO;
        case MAGIC_ALT2_Q: return KC_NO;
        case MAGIC_ALT2_T: return KC_NO;
        case MAGIC_ALT2_W: return KC_NO;
