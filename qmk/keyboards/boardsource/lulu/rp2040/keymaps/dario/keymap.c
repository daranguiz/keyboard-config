...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE_PRIMARY] = LAYOUT(
        ...
        KC_NO               , KC_B                , KC_F                , KC_L                , KC_D                , KC_Q                , KC_J                , KC_G                , KC_O                , KC_U                , KC_DOT              , KC_NO               ,
        QK_REP              , LGUI_T(KC_N)        , LALT_T(KC_S)        , LCTL_T(KC_H)        , LSFT_T(KC_T)        , KC_K                , KC_Y                , LSFT_T(KC_C)        , LCTL_T(KC_A)        , LALT_T(KC_E)        , LGUI_T(KC_I)        , QK_REP              ,
