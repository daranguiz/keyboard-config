// Hardware configuration for Ripple (Cosmos Dactyl)
// Matrix pins are PLACEHOLDER - replace with actual wiring

#pragma once

#include "keyboards/ripple/vik/config.vik.pre.h"
...
#include "keyboards/ripple/vik/config.vik.post.h"
