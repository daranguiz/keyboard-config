...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE] = LAYOUT(
        ...
        KC_NO               , LGUI_T(KC_A)        , LALT_T(KC_R)        , LCTL_T(KC_S)        , LSFT_T(KC_T)        , KC_D                ,
        KC_H                , LSFT_T(KC_N)        , LCTL_T(KC_E)        , LALT_T(KC_I)        , LGUI_T(KC_O)        , KC_NO               ,
        KC_NO               , KC_Z                , LT(FUN, KC_X)       , KC_C                , KC_V                , KC_B                ,
        KC_K                , KC_M                , KC_COMM             , ALGR_T(KC_DOT)      , KC_SLSH             , KC_NO               ,
        KC_NO               , KC_NO               , KC_ENT              , LT(NAV, KC_SPC)     , LT(MEDIA, KC_TAB)   , LT(SYM, KC_DEL)     ,
        KC_LSFT             , LT(NUM, KC_BSPC)    , KC_NO               , KC_NO               
    ),
    [NAV] = LAYOUT(
        KC_NO               , KC_NO               , KC_NO               , KC_NO               , KC_NO               , KC_NO               ,
        KC_NO               , KC_NO               , KC_NO               , KC_NO               , KC_NO               , KC_NO               ,
        ...
        KC_CAPS             , KC_LEFT             , KC_DOWN             , KC_UP               , KC_RGHT             , KC_NO               ,
        KC_NO               , KC_NO               , KC_NO               , KC_NO               , KC_NO               , KC_NO               ,
    ...
    [MEDIA] = LAYOUT(
        ...
        KC_NO               , KC_NO               , KC_NO               , KC_NO               , KC_NO               , KC_NO               ,
        KC_NO               , KC_NO               , KC_NO               , KC_NO               , KC_NO               , KC_MSTP             ,
        KC_MPLY             , KC_MUTE             , KC_NO               , KC_NO               
    ),
    [NUM] = LAYOUT(
        KC_NO               , KC_NO               , KC_NO               , KC_NO               , KC_NO               , KC_NO               ,
        KC_NO               , KC_NO               , KC_NO               , KC_NO               , KC_NO               , KC_NO               ,
        ...
        KC_NO               , KC_NO               , KC_NO               , KC_NO               , KC_NO               , KC_NO               ,
        KC_NO               , KC_SCLN             , KC_1                , KC_2                , KC_3                , KC_EQL              ,
        KC_NO               , KC_LSFT             , KC_LCTL             , KC_LALT             , KC_LGUI             , KC_NO               ,
        KC_NO               , KC_GRV              , KC_7                , KC_8                , KC_9                , KC_BSLS             ,
        KC_NO               , KC_NO               , KC_NO               , KC_ALGR             , KC_NO               , KC_NO               ,
        KC_NO               , KC_NO               , KC_COLN             , KC_0                , KC_MINS             , KC_NO               ,
        KC_NO               , KC_NO               , KC_NO               , KC_NO               
    ),
    [SYM] = LAYOUT(
        KC_NO               , KC_NO               , KC_NO               , KC_NO               , KC_NO               , KC_NO               ,
        KC_NO               , KC_NO               , KC_NO               , KC_NO               , KC_NO               , KC_NO               ,
        KC_NO               , KC_LCBR             , KC_DLR              , KC_PERC             , KC_CIRC             , KC_RCBR             ,
        KC_NO               , KC_NO               , KC_NO               , KC_NO               , KC_NO               , KC_NO               ,
        KC_NO               , KC_COLN             , KC_EXLM             , KC_AT               , KC_HASH             , KC_PLUS             ,
        KC_NO               , KC_LSFT             , KC_LCTL             , KC_LALT             , KC_LGUI             , KC_NO               ,
        KC_NO               , KC_TILD             , KC_AMPR             , KC_ASTR             , KC_LPRN             , KC_PIPE             ,
        KC_NO               , KC_NO               , KC_NO               , KC_ALGR             , KC_NO               , KC_NO               ,
        KC_NO               , KC_NO               , KC_LPRN             , KC_RPRN             , KC_UNDS             , KC_NO               ,
        KC_NO               , KC_NO               , KC_NO               , KC_NO               
    ),
    [FUN] = LAYOUT(
        KC_NO               , KC_NO               , KC_NO               , KC_NO               , KC_NO               , KC_NO               ,
        ...
        KC_NO               , KC_NO               , KC_NO               , KC_ALGR             , KC_NO               , KC_NO               ,
        KC_NO               , KC_NO               , KC_APP              , KC_SPC              , KC_TAB              , KC_NO               ,
        KC_NO               , KC_NO               , KC_NO               , KC_NO               
    ),
};
