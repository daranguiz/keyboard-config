...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [SYM] = LAYOUT(
        KC_NO               , KC_NO               , KC_NO               , KC_NO               , KC_NO               , KC_NO               , KC_NO               , KC_NO               , KC_NO               , KC_NO               , KC_NO               , KC_NO               ,
        KC_TRNS             , KC_NO               , KC_NO               , KC_TILD             , OSL(NUM)            , KC_NO               , KC_LT               , KC_PLUS             , KC_LCBR             , KC_RCBR             , KC_EQL              , KC_TRNS             ,
    ...
    [NUM] = LAYOUT(
        KC_NO               , KC_NO               , KC_NO               , KC_NO               , KC_NO               , KC_NO               , KC_NO               , KC_NO               , KC_NO               , KC_NO               , KC_NO               , KC_NO               ,
        KC_TRNS             , KC_NO               , KC_NO               , KC_TILD             , OSL(SYM_SHADOW)     , KC_NO               , KC_LBRC             , KC_7                , KC_8                , KC_9                , KC_DOT              , KC_TRNS             ,
