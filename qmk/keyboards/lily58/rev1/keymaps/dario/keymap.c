...
enum {
    GAME = SYM_SHADOW + 1  // Continue from last standard layer
};
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE_PRIMARY] = LAYOUT(
        ...
        QK_REP              , LGUI_T(KC_N)        , LALT_T(KC_S)        , LCTL_T(KC_H)        , LSFT_T(KC_T)        , KC_D                , KC_Y                , LSFT_T(KC_C)        , LCTL_T(KC_A)        , LALT_T(KC_E)        , LGUI_T(KC_I)        , QK_REP              ,
        KC_NO               , KC_X                , KC_V                , KC_M                , KC_P                , KC_Z                , KC_NO               , KC_NO               , KC_QUOT             , KC_W                , KC_MINS             , KC_SLSH             , KC_COMM             , KC_NO               ,
    ...
    [SYM] = LAYOUT(
        KC_NO               , KC_NO               , KC_NO               , KC_NO               , KC_NO               , KC_NO               , KC_NO               , KC_NO               , KC_NO               , KC_NO               , KC_NO               , KC_NO               ,
        KC_TRNS             , KC_AMPR             , KC_PERC             , KC_DLR              , OSL(NUM)            , KC_NO               , KC_HASH             , KC_PLUS             , KC_LCBR             , KC_RCBR             , KC_EQL              , KC_TRNS             ,
        KC_TRNS             , LGUI_T(KC_LABK)     , LALT_T(KC_RABK)     , LCTL_T(KC_LBRC)     , LSFT_T(KC_RBRC)     , KC_NO               , KC_SCLN             , KC_EXLM             , KC_LPRN             , KC_RPRN             , KC_COLN             , KC_TRNS             ,
        KC_TRNS             , KC_CIRC             , KC_PIPE             , KC_TILD             , KC_BSLS             , KC_NO               , KC_NO               , KC_NO               , KC_DQUO             , KC_ASTR             , KC_UNDS             , KC_QUES             , KC_COMM             , KC_TRNS             ,
    ...
    [NAV] = LAYOUT(
        KC_NO               , KC_NO               , KC_NO               , KC_NO               , KC_NO               , KC_NO               , KC_NO               , KC_NO               , KC_NO               , KC_NO               , KC_NO               , KC_NO               ,
        KC_TRNS             , KC_NO               , KC_PGUP             , KC_NO               , CW_TOGG             , KC_ESC              , KC_NO               , KC_NO               , KC_NO               , KC_NO               , KC_NO               , KC_TRNS             ,
