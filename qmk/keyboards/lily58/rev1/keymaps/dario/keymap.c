...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [BASE_ALT] = LAYOUT(
        KC_NO               , KC_NO               , KC_NO               , KC_NO               , KC_NO               , KC_NO               , KC_NO               , KC_NO               , KC_NO               , KC_NO               , KC_NO               , KC_NO               ,
        KC_NO               , KC_B                , KC_F                , KC_L                , KC_K                , KC_Q                , KC_QUOT             , KC_G                , KC_O                , KC_U                , KC_DOT              , KC_NO               ,
        KC_Y                , LGUI_T(KC_N)        , LALT_T(KC_S)        , LCTL_T(KC_H)        , LSFT_T(KC_T)        , KC_M                , KC_Y                , LSFT_T(KC_C)        , LCTL_T(KC_A)        , LALT_T(KC_E)        , LGUI_T(KC_I)        , KC_NO               ,
        KC_NO               , KC_X                , KC_P                , KC_J                , KC_D                , KC_V                , KC_NO               , KC_NO               , KC_Z                , KC_W                , KC_MINS             , KC_SCLN             , KC_COMM             , KC_NO               ,
        KC_NO               , LT(NUM, KC_BSPC)    , LT(SYM, KC_R)       , LSFT_T(QK_AREP)     , LSFT_T(KC_TAB)      , LT(NAV, KC_SPC)     , LT(MEDIA, KC_ENT)   , KC_NO               
    ),
    [NUM] = LAYOUT(
        KC_NO               , KC_NO               , KC_NO               , KC_NO               , KC_NO               , KC_NO               , KC_NO               , KC_NO               , KC_NO               , KC_NO               , KC_NO               , KC_NO               ,
        KC_NO               , KC_TILD             , KC_AMPR             , KC_PERC             , KC_DLR              , KC_NO               , KC_CIRC             , KC_7                , KC_8                , KC_9                , KC_DOT              , KC_NO               ,
        KC_NO               , KC_LGUI             , KC_LALT             , KC_LCTL             , KC_LSFT             , KC_EQL              , KC_COLN             , KC_1                , KC_2                , KC_3                , KC_GRV              , KC_NO               ,
        KC_NO               , LGUI(KC_Z)          , LGUI(KC_X)          , LGUI(KC_C)          , LGUI(KC_V)          , SGUI(KC_Z)          , KC_NO               , KC_NO               , KC_HASH             , KC_4                , KC_5                , KC_6                , KC_COMM             , KC_NO               ,
        KC_NO               , KC_NO               , KC_NO               , KC_NO               , QK_AREP             , KC_0                , KC_AT               , KC_NO               
    ),
    [SYM] = LAYOUT(
        KC_NO               , KC_NO               , KC_NO               , KC_NO               , KC_NO               , KC_NO               , KC_NO               , KC_NO               , KC_NO               , KC_NO               , KC_NO               , KC_NO               ,
        KC_NO               , KC_TILD             , KC_AMPR             , KC_PERC             , KC_DLR              , KC_NO               , KC_PLUS             , KC_LT               , KC_LCBR             , KC_RCBR             , KC_GT               , KC_NO               ,
        KC_NO               , KC_LGUI             , KC_LALT             , KC_LCTL             , KC_LSFT             , KC_EQL              , KC_COLN             , KC_EXLM             , KC_LPRN             , KC_RPRN             , KC_SCLN             , KC_NO               ,
        KC_NO               , KC_NO               , KC_NO               , KC_PIPE             , KC_BSLS             , KC_NO               , KC_NO               , KC_NO               , KC_ASTR             , KC_MINS             , KC_LBRC             , KC_RBRC             , KC_COMM             , KC_NO               ,
    ...
    [MEDIA] = LAYOUT(
        KC_NO               , KC_NO               , KC_NO               , KC_NO               , KC_NO               , KC_NO               , KC_NO               , KC_NO               , KC_NO               , KC_NO               , KC_NO               , KC_NO               ,
        KC_NO               , DF(BASE_PRIMARY)    , DF(BASE_ALT)        , KC_NO               , KC_NO               , KC_NO               , KC_NO               , KC_NO               , KC_NO               , KC_NO               , KC_NO               , KC_NO               ,
