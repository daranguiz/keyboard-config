...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE_PRIMARY] = LAYOUT_split_3x5_3(
        ...
        KC_J                , KC_G                , KC_O                , KC_U                , KC_DOT              ,
        LGUI_T(KC_N)        , LALT_T(KC_S)        , LCTL_T(KC_H)        , LSFT_T(KC_T)        , KC_M                ,
        KC_Y                , LSFT_T(KC_C)        , LCTL_T(KC_A)        , LALT_T(KC_E)        , LGUI_T(KC_I)        ,
        KC_X                , KC_V                , KC_P                , KC_D                , KC_Z                ,
        KC_QUOT             , KC_W                , KC_MINS             , KC_SCLN             , KC_COMM             ,
                              LT(NUM, KC_BSPC)    , LT(SYM, KC_R)       , LSFT_T(QK_AREP)     ,
                              LSFT_T(KC_TAB)      , LT(NAV, KC_SPC)     , LT(MEDIA, KC_ENT)   
    ),
    [BASE_ALT] = LAYOUT_split_3x5_3(
        KC_B                , KC_F                , KC_L                , KC_K                , KC_Q                ,
        KC_QUOT             , KC_G                , KC_O                , KC_U                , KC_DOT              ,
        LGUI_T(KC_N)        , LALT_T(KC_S)        , LCTL_T(KC_H)        , LSFT_T(KC_T)        , KC_M                ,
        KC_Y                , LSFT_T(KC_C)        , LCTL_T(KC_A)        , LALT_T(KC_E)        , LGUI_T(KC_I)        ,
        KC_X                , KC_P                , KC_J                , KC_D                , KC_V                ,
        KC_Z                , KC_W                , KC_MINS             , KC_SCLN             , KC_COMM             ,
                              LT(NUM, KC_BSPC)    , LT(SYM, KC_R)       , LSFT_T(QK_AREP)     ,
                              LSFT_T(KC_TAB)      , LT(NAV, KC_SPC)     , LT(MEDIA, KC_ENT)   
    ),
    [NUM] = LAYOUT_split_3x5_3(
        KC_DLR              , KC_TILD             , KC_PERC             , KC_COLN             , KC_NO               ,
        ...
        KC_COLN             , KC_4                , KC_5                , KC_6                , KC_COMM             ,
                              KC_NO               , KC_NO               , KC_NO               ,
                              KC_SLSH             , KC_0                , KC_AT               
    ),
    [SYM] = LAYOUT_split_3x5_3(
        KC_DLR              , KC_ASTR             , KC_PERC             , KC_BSLS             , KC_NO               ,
        ...
        KC_COLN             , KC_MINS             , KC_LBRC             , KC_RBRC             , KC_COMM             ,
                              KC_NO               , KC_NO               , KC_NO               ,
    ...
    [MEDIA] = LAYOUT_split_3x5_3(
        DF(BASE_PRIMARY)    , DF(BASE_ALT)        , KC_NO               , KC_NO               , KC_NO               ,
        KC_NO               , KC_NO               , KC_NO               , KC_NO               , KC_NO               ,
