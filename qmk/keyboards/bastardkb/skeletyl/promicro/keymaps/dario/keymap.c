...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [SYM] = LAYOUT_split_3x5_3(
        KC_AMPR             , KC_PERC             , KC_DLR              , KC_GT               , KC_TILD             , KC_LT               , KC_PLUS             , KC_LCBR             , KC_RCBR             , KC_EQL              ,
        KC_LGUI             , KC_LALT             , KC_LCTL             , KC_LSFT             , KC_BSLS             , KC_SCLN             , KC_EXLM             , KC_LPRN             , KC_RPRN             , KC_COLN             ,
